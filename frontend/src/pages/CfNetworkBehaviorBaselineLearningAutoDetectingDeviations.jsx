...
// Feature: Network behavior baseline learning auto-detecting deviations
...
export default function CfNetworkBehaviorBaselineLearningAutoDetectingDeviations() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/cf-network-behavior-baseline-learning-auto-detecting-deviations/run`, {
        method: 'POST', headers: getHeaders(),
        body: JSON.stringify({ prompt: input, feature: 'cf-network-behavior-baseline-learning-auto-detecting-deviations', project: 'AIVideoIntelligence' })
      })
  ...
  const loadHistory = async () => {
    try {
      const res = await fetch(`${API_BASE}/api/cf-network-behavior-baseline-learning-auto-detecting-deviations/history`, { headers: getHeaders() })
      const data = await res.json()
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-slate-800">Network behavior baseline learning auto-detecting deviations</h1>
